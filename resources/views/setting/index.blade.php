                            ...
                            <div class="tab-content mt-4" id="settingTabContent">
                                    ...
                                    <form action="{{ route('setting.update') }}" method="POST">
                                        ...
                                        <div class="mt-3 text-right">
                                            <button type="submit" class="btn btn-primary">
                                                <i class="fas fa-save"></i> Simpan Koneksi MikroTik
                                            </button>
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="tab-pane fade" id="billing" role="tabpanel">
                                    <form action="{{ route('setting.update') }}" method="POST">
                                        ...
                                        <div class="mt-3 text-right">
                                            <button type="submit" class="btn btn-primary">
                                                <i class="fas fa-save"></i> Simpan Konfigurasi Billing
                                            </button>
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="tab-pane fade" id="whatsapp" role="tabpanel">
                                    <div class="mt-2">
                                        {{-- Token Input (Separate AJAX form already handled by scripts) --}}
                                        <div class="row">
                                            <div class="col-md-8">
                                        ...
                                        {{-- Template Pesan (Form for Template) --}}
                                        <form action="{{ route('setting.update') }}" method="POST">
                                            @csrf
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label><strong>Template Pesan Tagihan WhatsApp</strong></label>
                                                        <textarea name="wa_invoice_template" class="form-control" rows="10" placeholder="Masukkan template pesan...">{{ old('wa_invoice_template', $billing->wa_invoice_template) }}</textarea>
                                                        <div class="mt-2">
                                                            <small class="text-muted">
                                                                <strong>Placeholder yang tersedia:</strong><br>
                                                                <code>[nama_pelanggan]</code>, <code>[id_pelanggan]</code>, <code>[no_invoice]</code>, <code>[periode]</code>, <code>[paket]</code>, <code>[jatuh_tempo]</code>, <code>[total_tagihan]</code>, <code>[rekening_pembayaran]</code>
                                                            </small>
                                                        </div>
                                                        <div class="mt-1">
                                                            <small class="text-info italic">
                                                                * <code>[rekening_pembayaran]</code> akan otomatis kosong jika pelanggan tidak memiliki nomor BRIVA.
                                                            </small>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mt-2 text-right">
                                                <button type="submit" class="btn btn-primary">
                                                    <i class="fas fa-save"></i> Simpan Template WhatsApp
                                                </button>
                                            </div>
                                        </form>
